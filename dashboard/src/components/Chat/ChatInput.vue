    ...
    <div class="flex items-center space-x-3">
      ...
      <form id="message-form" @submit.prevent="sendMessage" class="flex-1 flex flex-col space-y-2">
        ...
        <textarea ref="textareaRef" v-model="input"
          ...
          class="flex-1 border-2 border-gray-600 rounded shadow-[inset_2px_2px_4px_rgba(0,0,0,0.3)] px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-700 disabled:text-gray-500 resize-none min-h-[48px] max-h-[200px] overflow-y-auto nes-input text-xs chat-input-textarea"
          :class="hasChineseCharacters ? 'zh' : 'pixel-font'" :disabled="isLoading || props.disabled" rows="1" @input="autoResize"
